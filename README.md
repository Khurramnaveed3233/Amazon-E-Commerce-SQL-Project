...
/* =============================================================
   Amazon E-Commerce SQL Project: Top 5 Strategic Queries
   ============================================================= */

/* 1. Sales Impact Analysis: Before vs. After Discount
   Objective: Evaluate the effectiveness of discount campaigns by comparing 
   sales volume before and after specific dates (e.g., '2023-12-01').
*/
SELECT 
    p.ProductName,
...
/* 2. Profitability Analysis by Category
   Objective: Identify high-margin product categories to optimize inventory 
   and marketing focus. (Calculates Revenue - Cost).
*/
SELECT 
    c.CategoryName,
...
/* 3. Monthly Sales Trends (Seasonality)
   Objective: Track revenue performance over the last 12 months to identify 
   seasonal peaks and growth trends.
*/
SELECT 
...
/* 4. Customer Lifetime Value (CLV)
   Objective: Calculate the total revenue generated by each customer to 
   identify VIP clients for loyalty programs.
*/
SELECT 
    c.CustomerID,
...
/* 5. Top 5 Best-Selling Products
   Objective: Determine the most popular products by quantity sold to 
   inform restocking decisions.
*/
SELECT TOP 5
    p.ProductName,
